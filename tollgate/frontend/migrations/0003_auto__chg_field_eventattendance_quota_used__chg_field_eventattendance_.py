...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EventAttendance.quota_used'
        db.alter_column('frontend_eventattendance', 'quota_used', self.gf('django.db.models.fields.BigIntegerField')())

        # Changing field 'EventAttendance.quota_amount'
        db.alter_column('frontend_eventattendance', 'quota_amount', self.gf('django.db.models.fields.BigIntegerField')())

        # Changing field 'NetworkUsageDataPoint.bytes'
        db.alter_column('frontend_networkusagedatapoint', 'bytes', self.gf('django.db.models.fields.BigIntegerField')())
    def backwards(self, orm):

        # Changing field 'EventAttendance.quota_used'
        db.alter_column('frontend_eventattendance', 'quota_used', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'EventAttendance.quota_amount'
        db.alter_column('frontend_eventattendance', 'quota_amount', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'NetworkUsageDataPoint.bytes'
        db.alter_column('frontend_networkusagedatapoint', 'bytes', self.gf('django.db.models.fields.PositiveIntegerField')())
    models = {
        'auth.group': {
